...
import bg1 from '../images/wave.svg'
            ...
            <div>
                ...
                <main>
                    ...
                    <ButtonGroup aria-label="Basic example">
                        <Button variant="secondary" value="Daily" className="Button" onClick={this.handleButtonClick}>Daily</Button>
                        <Button variant="secondary" value="Weekly" className="Button" onClick={this.handleButtonClick}>Weekly</Button>
                        <Button variant="secondary" value="Monthly" className="Button" onClick={this.handleButtonClick}>Monthly</Button>
